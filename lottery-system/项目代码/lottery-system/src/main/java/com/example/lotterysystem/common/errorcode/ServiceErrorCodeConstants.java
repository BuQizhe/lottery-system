...
public interface ServiceErrorCodeConstants {
    ...
    ErrorCode USER_NOT_LOGIN = new ErrorCode(112, "用户未登录");

    // ------ 奖品模块错误码 --------
    ErrorCode PRIZE_ID_IS_EMPTY = new ErrorCode(201, "奖品ID不能为空");
    ErrorCode PRIZE_NOT_EXIST = new ErrorCode(202, "奖品不存在");
    ErrorCode PROBABILITY_ERROR = new ErrorCode(203, "概率设置错误，应在0-100之间");
    ErrorCode STOCK_ERROR = new ErrorCode(204, "库存设置错误");
    ErrorCode NO_PRIZE = new ErrorCode(205, "暂无可用奖品");
    ErrorCode PRIZE_OUT_OF_STOCK = new ErrorCode(206, "奖品已抽完");
    ErrorCode PRIZE_UPDATE_ERROR = new ErrorCode(207, "奖品更新失败");
    ...
    ErrorCode USER_ID_IS_EMPTY = new ErrorCode(600, "用户ID不能为空");
    ErrorCode USER_NOT_EXIST = new ErrorCode(601, "用户不存在");

    // ------ 邮件错误码 --------

    ErrorCode SEND_EMAIL_ERROR = new ErrorCode(700, "发送邮件失败，请稍后重试");
}